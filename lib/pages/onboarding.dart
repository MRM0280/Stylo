...
class _OnBoardongState extends State<OnBoardong> {
  ...
  final pageList = [
    PageModel(
      ...
      heroImagePath: 'assets/onboarding_images/onboarding_1.png',
      ...
      iconImagePath: 'assets/onboarding_images/onboarding_1.png',
    ),
    PageModel(
      color: Colors.red[300],
      heroImagePath: 'assets/onboarding_images/onboarding_2.png',
      ...
      iconImagePath: 'assets/onboarding_images/onboarding_2.png',
    ),
    PageModel(
      color: Colors.pink,
      heroImagePath: 'assets/onboarding_images/onboarding_3.png',
      ...
      iconImagePath: 'assets/onboarding_images/onboarding_3.png',
    ),
  ];
